                ...
                <Grid item xs={12} md={6} sx={{ display: "flex", flexDirection: "column" }}>
                    <Paper square sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
                        <Box sx={{ p: 5, flex: 1 }} component="form" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <TextField fullWidth id="email" sx={{ mb: 3 }} label="Email" variant="outlined"
                                {...register('email', {
                            ...
                            />
                            <TextField fullWidth id="password" sx={{ mb: 3 }} label="Password" variant="outlined" type='password'
                                {...register('password', { required: "This field is required" })}
                                error={!!errors.password}
                                helperText={errors.password ? errors.password.message : ''}
                            />
                            <Button fullWidth type='submit' variant="contained" sx={{ py: 2, bgcolor: "#00ED64" }}>Login</Button>
                            <Button sx={{ mt: 1 }}>Forgot Password</Button>
                        </Box>
                        <Box sx={{ textAlign: "right", pr: 1, pb: 1 }}>
                            <Typography sx={{ color: "#001E2B" }}>
                                Don't have an account <Button onClick={() => navigate('/register')} sx={{ color: "#001E2B" }}>Create Account</Button>
                            </Typography>
                        </Box>
                    </Paper>
                </Grid>
